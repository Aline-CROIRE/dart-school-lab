...
|:--------:|--------------------------|:----------:|
| **Q1** | `welcomeMessage()` function displays the welcome message | ![Q1 Screenshot](screenshoots/q1.jpeg) |
| **Q2** | `createStudent()` with named parameters | ![Q2 Screenshot](screenshoots/q2.jpeg) |
